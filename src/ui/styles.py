...
.auth-title {{ font-size:1.4rem; font-weight:700; color:var(--accent-purple); margin-bottom:0.2rem; }}
.auth-sub   {{ font-size:0.88rem; color:var(--text-muted); margin-bottom:1.4rem; }}

.section-header {{ font-size:1rem; font-weight:600; color:var(--text-primary); margin-bottom:0.5rem; }}
...
.metric-tile-label {{ font-size:11px; color:var(--text-muted); margin:2px 0 0; }}
.metric-tile-value {{ font-size:16px; font-weight:600; margin:8px 0 0; color:var(--text-primary); }}
...
.goal-title {{ font-size:0.85rem; font-weight:600; color:var(--text-primary); opacity:0.8; margin-bottom:6px; }}
...
.day-header {{ font-size:0.85rem; font-weight:600; color:var(--accent-purple); margin-bottom:0.5rem; letter-spacing:0.03em; }}

.task-row {{
    display:flex; align-items:center; gap:8px; padding:5px 0;
    border-bottom:0.5px solid var(--border); font-size:0.88rem; color:var(--text-primary);
}}
...
.timer-label {{
    font-size:0.85rem; font-weight:600; color:var(--accent-purple);
    text-transform:uppercase; letter-spacing:0.1em; margin-top:0.4rem; opacity:0.85;
}}
...
.session-log-row {{
    ...
    background:var(--bg-surface); margin-bottom:4px; font-size:0.84rem; color:var(--text-primary);
}}
...
.rec-badge {{ font-size:0.7rem; font-weight:700; padding:2px 8px; border-radius:20px; text-transform:uppercase; letter-spacing:0.05em; }}
...
.rec-title {{ font-size:0.95rem; font-weight:700; color:var(--text-primary); }}
.rec-body  {{ font-size:0.87rem; opacity:0.9; line-height:1.55; margin:0; color:var(--text-primary); }}
.rec-action {{ margin-top:8px; padding:5px 10px; border-radius:6px; font-size:0.8rem; font-weight:600; background:var(--bg-surface-raised); display:inline-block; color:var(--text-primary); }}
...
.landing-sub {{
    font-size: 1.15rem; color: var(--text-secondary); margin-bottom: 2.5rem;
...
.feature-title {{ font-size: 0.95rem; font-weight: 700; color: var(--accent-purple); margin-bottom: 0.3rem; }}
...
.stat-val  {{ font-size: 2rem; font-weight: 800; color: var(--accent-purple); line-height: 1; }}
.stat-lbl  {{ font-size: 0.78rem; color: var(--text-muted); margin-top: 4px; text-transform: uppercase; letter-spacing: 0.05em; }}
...
.ssm-ch{text-align:center;font-size:0.68rem;font-weight:700;color:var(--text-muted);
...
.ssm-sc{font-size:0.6rem;opacity:0.85;line-height:1;}
