  ...
  <span style="font-size:0.7rem;color:#555;display:flex;align-items:center;gap:4px;">
    <span style="width:9px;height:9px;border-radius:3px;border:1.5px dashed #AFA9EC;
        ...
        with form_col:
            ...
            exercise_weekly_equiv = exercise * 7  # 0 or 7 (binary today → weekly scale)
            raw = (
                max(0, study - 8) * 3.5 + assignments * 2.5 + (exam - 1) * 5.0
                + max(0, 7 - sleep) * 4.0 + max(0, 5 - exercise_weekly_equiv) * 2.0
            ...
            if MODEL_READY:
                inp        = np.array([[study, assignments, exam, performance,
                                        sleep, exercise_weekly_equiv, social, screen,
    ...
    if current_page == "summary":
        ...
        if history_df.empty:
            ...
            if week_df.empty:
                ...
                exercise_days_w = int(week_df["exercise"].sum())
            ...
            if month_df.empty:
                ...
                exercise_days_m = int(month_df["exercise"].sum())
